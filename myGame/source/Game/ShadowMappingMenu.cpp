...
namespace Rendering
{
	RTTI_DEFINITIONS(ShadowMappingMenu)



		void ShadowMappingMenu::Initialize()
	{
	...
	//		}
		...
		std::wstring textureName = L"content\\Textures\\menu.png";
		...
		XMStoreFloat4x4(&mPlaneWorldMatrix, XMMatrixRotationX(0.0f) * XMMatrixRotationY(0.0f) * XMMatrixRotationZ(0.0f) * XMMatrixScaling(40.0f, 20.0f, 0.0f) * XMMatrixTranslation(0.0f, 4.5f, -20.5f));
	...
	ShadowMappingMenu::ShadowMappingMenu(Library::Game& game, Library::Camera& camera) : ShadowMappingBase(game, camera) {}
