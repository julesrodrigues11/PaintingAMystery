...
namespace Rendering
{
    RTTI_DEFINITIONS(TriangleDemo)
        ...
        mInputLayout(nullptr), mWorldMatrix(MatrixHelper::Identity), mVertexBuffer(nullptr), mIndexBuffer(nullptr), mAngle(0.0f), mTextureShaderResourceView(nullptr), mColorTextureVariable(nullptr)
    {
    }
    ...
    shaderFlags |= D3DCOMPILE_SKIP_OPTIMIZATION;
     ...
     //       BasicEffectVertex(XMFLOAT4(-5.0f, 0.0f, -5.0f, 1.0f), XMFLOAT4(0.0f, 1.0f,0.5f,1.0f)),//V0
      //      BasicEffectVertex(XMFLOAT4(5.0f, 0.0f, -5.0f, 1.0f), XMFLOAT4(0.0f, 1.0f, 0.5f, 1.0f)),//V1 
      //      BasicEffectVertex(XMFLOAT4(5.0f, 0.0f, 5.0f, 1.0f), XMFLOAT4(0.0f, 1.0f, 0.5f, 1.0f)),//V2
      //      BasicEffectVertex(XMFLOAT4(-5.0f, 0.0f, 5.0f, 1.0f), XMFLOAT4(0.0f, 1.0f, 0.5f, 1.0f)),//V3 
    //BasicEffectVertex(XMFLOAT4(-0.25, -0.25f, -0.25f, 1.0f), XMFLOAT4(1.0f, 0.0f,0.0f,1.0f)),//V0
    //BasicEffectVertex(XMFLOAT4(0.25f, 0.25f, -0.25f, 1.0f), XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f)),//V1 
   // BasicEffectVertex(XMFLOAT4(0.25f, -0.25f, -0.25f, 1.0f), XMFLOAT4(1.0f, 1.0f, 0.0f, 1.0f)),//V2 
   // BasicEffectVertex(XMFLOAT4(0.25f, 0.25f, 0.25f, 1.0f), XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f)),//V3
   // BasicEffectVertex(XMFLOAT4(-0.25f, -0.25f, 0.25f, 1.0f), XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f)),//V4
   // BasicEffectVertex(XMFLOAT4(-0.25f, 0.25f, 0.25f, 1.0f), XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f)),//5
    //BasicEffectVertex(XMFLOAT4(-0.25f, 0.25f, -0.25f, 1.0f), XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f)),//V6
   // BasicEffectVertex(XMFLOAT4(0.25f, -0.25f, 0.25f, 1.0f), XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f)),//V7

  //  BasicEffectVertex(XMFLOAT4(-1.0f, 0.0f, -1.0f, 1.0f), XMFLOAT4(1.0f, 0.0f,0.0f,1.0f)),//red
   // BasicEffectVertex(XMFLOAT4(0.0f, 1.0f, -1.0f, 1.0f), XMFLOAT4(0.0f, 1.0f, 0.0f, 1.0f)),//green
   // BasicEffectVertex(XMFLOAT4(1.0f, 0.0f, -1.0f, 1.0f), XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f)),//blue
   // BasicEffectVertex(XMFLOAT4(-1.0f, 0.0f, -1.0f, 1.0f), XMFLOAT4(1.0f, 0.0f,0.0f,1.0f)),//red
   // BasicEffectVertex(XMFLOAT4(0.0f, -1.0f, -1.0f, 1.0f), XMFLOAT4(0.0f, 1.0f, 0.0f, 1.0f)),//green
   // BasicEffectVertex(XMFLOAT4(1.0f, 0.0f, -1.0f, 1.0f), XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f)),//blue
   // BasicEffectVertex(XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f), XMFLOAT4(1.0f, 0.0f,0.0f,1.0f)),//red
  //  BasicEffectVertex(XMFLOAT4(1.0f, -1.0f, 0.0f, 1.0f), XMFLOAT4(0.0f, 1.0f, 0.0f, 1.0f)),//green
   // BasicEffectVertex(XMFLOAT4(0.0f, 0.0f, -1.0f, 1.0f), XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f)),//blue
  //  BasicEffectVertex(XMFLOAT4(-1.0f, 0.0f, 0.0f, 1.0f), XMFLOAT4(1.0f, 0.0f,0.0f,1.0f)),//red
  //  BasicEffectVertex(XMFLOAT4(-1.0f, -1.0f, 0.0f, 1.0f), XMFLOAT4(0.0f, 1.0f, 0.0f, 1.0f)),//green
  //  BasicEffectVertex(XMFLOAT4(0.0f, 0.0f, -1.0f, 1.0f), XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f)),//blue
   // BasicEffectVertex(XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f), XMFLOAT4(1.0f, 0.0f,0.0f,1.0f)),//red
  ...
  //  BasicEffectVertex(XMFLOAT4(1.0f, 1.0f, 0.0f, 1.0f), XMFLOAT4(0.0f, 1.0f, 0.0f, 1.0f)),//green
   ...
   // BasicEffectVertex(XMFLOAT4(0.0f, -1.0f, 1.0f, 1.0f), XMFLOAT4(0.0f, 1.0f, 0.0f, 1.0f)),//green
	...
	{
        //mAngle += 1 * static_cast<float>(gameTime.ElapsedGameTime());
        //XMStoreFloat4x4(&mWorldMatrix, XMMatrixRotationRollPitchYaw(-mAngle, mAngle, -mAngle));
	}
