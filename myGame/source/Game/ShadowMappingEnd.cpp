...
namespace Rendering
{
	RTTI_DEFINITIONS(ShadowMappingEnd)



		void ShadowMappingEnd::Initialize()
	{
	...
	//		}
		...
		std::wstring textureName = L"content\\Textures\\end.png";
	...
	ShadowMappingEnd::ShadowMappingEnd(Library::Game& game, Library::Camera& camera) : ShadowMappingBase(game, camera) {}
